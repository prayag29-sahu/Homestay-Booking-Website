...
function Footer({ setIsLoggedIn }) {
    const handleLogout = () => {
        setIsLoggedIn(false);   // This will immediately log the user out
    };
                                ...
                                <div>
                                    ...
                                    <div className="flex flex-col gap-3 mt-5">
                                        <button
                                            ...
                                            className="px-4 py-2 bg-red-500 text-white rounded-lg hover:bg-red-600 transition font-semibold w-fit"
                                        >
                                            Logout
                                        </button>
                                    </div>
