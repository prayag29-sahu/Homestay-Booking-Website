...
function Index() {
    ...
    const handleSubmit = (e) => {
        ...
        // Basic validation (optional, since inputs are already "required")
        if (!checkInDate || !checkOutDate || !adults) return;

        // Navigate to /rooms (you could also pass query params if needed)
        navigate("/rooms");
    };
    const isFormValid = checkInDate && checkOutDate && adults;
    ...
    return (
        ...
        <>
            ...
            <div
                id='ghotul'
                className="hero w-full lg:px-[12%] px-[8%] py-[150px] flex items-center justify-center relative overflow-hidden"
            >
                {/* Background Images */}
                ...
                <div className="hero-content w-full flex flex-col gap-4 z-10 relative">
                    ...
                    >
                        ...
                        <button
                            type="submit"
                            disabled={!isFormValid || new Date(checkOutDate) <= new Date(checkInDate)}
                            className={`rounded-full text-2xl xl:w-[60px] xl:h-[60px] w-[60px] h-[60px] flex items-center justify-center transition ${isFormValid && new Date(checkOutDate) > new Date(checkInDate)
                    ...
                    <button
                        ...
                        className="fixed bottom-6 left-6 flex items-center justify-center w-12 h-12 rounded-full bg-blue-600 text-white shadow-lg hover:bg-yellow-400 hover:text-black transition-all duration-300"
                    >
                        ?
                    </button>
                </div>
                ...
                <div className="about flex flex-col-reverse lg:flex-row items-center justify-between gap-20 relative z-auto">
                    ...
                    <div className="w-full lg:w-1/2 text-start ">
                        ...
                        <div className="flex w-full  flex-col sm:flex-row items-center gap-4 ">
                            <button onClick={() => navigate('/contact')} className='bg-[#fdc335] text-white px-6 py-3 rounded-full font-medium flex items-center gap-2 hover:bg-[#e6ae00] transition duration-300'>
                            ...
                            <button onClick={() => navigate('/contact')} className='text-[#1d2b3a] font-semibold flex items-center gap-2 hover:underline transition'>
                                Book Now
            ...
            <div id='review' className="bg-[f9fefe] w-full testimonials">
                <div className="w-full lg:w-[95%] mx-auto py-12 bg-[#eafbfb] rounded-[20px] box-sadow-larger relative z-auto">
            ...
            {/* Blog Section */}
            <div id='blogs' className='bg-[#f3fdfd] lg:px-[12%] px-[8%] py-[150px] flex flex-col items-center justify-center gap-10 z-auto relative overflow-hidden pt-[20px]'>
